        ...
        table.addListener(new Property.ValueChangeListener() {
            ...
            public void valueChange(ValueChangeEvent event) {
                ...
                if (rowId != null) {
                    ...
                    AdminContext.getSessionAttributes().setOrganizationName(obj.getOrganizationName());
                    AdminContext.getSessionAttributes().setOrganizationOid(obj.getHomeCommunityId());
                    AdminContext.getSessionAttributes().setOrganizationUSLaw(obj.getApplicableUsLaw());
                    AdminContext.getSessionAttributes().setOrganizationPolicy(provider.createOrganizationPolicyObjectFromXML(obj.getOrganizationalRules()));
