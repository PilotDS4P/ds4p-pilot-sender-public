...
public class DS4PSession {
    ...
    private OrganizationConsentPolicyInfo orgPolicyConsentPolicyInfo = new OrganizationConsentPolicyInfo();
    private DefaultPatientDemographics patientDemographics = new DefaultPatientDemographics();
    private OrganizationPolicy organizationPolicy = new OrganizationPolicy();
    ...
    /**
     * @return the orgPolicyConsentPolicyInfo
     */
    public OrganizationConsentPolicyInfo getOrgPolicyConsentPolicyInfo() {
        return orgPolicyConsentPolicyInfo;
    }

    /**
     * @param orgPolicyConsentPolicyInfo the orgPolicyConsentPolicyInfo to set
     */
    public void setOrgPolicyConsentPolicyInfo(OrganizationConsentPolicyInfo orgPolicyConsentPolicyInfo) {
        this.orgPolicyConsentPolicyInfo = orgPolicyConsentPolicyInfo;
    }



    /**
     * @return the organizationPolicy
     */
    ...
    /**
     * @param organizationPolicy the organizationPolicy to set
     */
     ...
     */
    public DefaultPatientDemographics getPatientDemographics() {
     ...
     */
    public void setPatientDemographics(DefaultPatientDemographics patientDemographics) {
