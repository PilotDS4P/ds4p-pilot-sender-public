    ...
    extends Service
{
    ...
    static {
        ...
        try {
            ...
            url = new URL(baseUrl, "https://uts.nlm.nih.gov/services/nwsSecurity?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'https://uts.nlm.nih.gov/services/nwsSecurity?wsdl', retrying as a local file");
