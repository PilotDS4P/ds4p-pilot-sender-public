...
@XmlRootElement(name = "suggestionGroup")
public class SuggestionGroup {

    @XmlElement(required = true)
    protected Name name;
    @XmlElement(required = true)
    protected SuggestionList suggestionList;
    ...
    /**
     * Sets the value of the suggestionList property.
     * 
     * @param value
     *     allowed object is
     *     {@link SuggestionList }
     *     
     */
    public void setSuggestionList(SuggestionList value) {
