 ...
 *       &lt;sequence>
 *         &lt;element ref="{}relationType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "relationTypeList")
public class RelationTypeList {

    @XmlElement(required = true)
    protected List<RelationType> relationType;
    ...
    public List<RelationType> getRelationType() {
        if (relationType == null) {
            relationType = new ArrayList<RelationType>();
        }
