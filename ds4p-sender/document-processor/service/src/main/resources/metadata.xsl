...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" exclude-result-prefixes="xs sdtc"
    ...
    <xsl:param name="authorTelecommunication" as="xs:string" select="'john.do@direct.com'"/>
    
    <xsl:param name="intendedRecipient" as="xs:string" select="'joe.bloggs@direct.com'"/>
    
    <xsl:param name="homeCommunityId" as="xs:string" select="'1.1.1.1.1'"/>

    <xsl:variable name="patientRole" select="//ClinicalDocument/recordTarget/patientRole"/>
                ...
                <ExtrinsicObject mimeType="text/xml"
                    ...
                    <Slot name="authorTelecommunication">
                        <ValueList>
                            <Value>
                                <xsl:value-of
                                    select="concat('^^Internet^', $authorTelecommunication)"/>
                            </Value>
                        </ValueList>
                    </Slot>
                    ...
                    <Classification id="cl07"
                        ...
                        nodeRepresentation="{$documentTypeInLoincCode}">
                        <Slot name="codingScheme">
                            <ValueList>
                                <Value>LOINC</Value>
                            </ValueList>
                    ...
                    <Classification id="c108"
                        ...
                        <Slot name="codingScheme">
                            <ValueList>
                                <Value>HITSP C80, version 2.0.1, table 2-146</Value> </ValueList>
                        </Slot>
                    </Classification>
